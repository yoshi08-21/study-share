...
describe("閲覧履歴一覧", () => {
  ...
  it("3冊の参考書を閲覧していると、3冊の参考書が閲覧履歴一覧に表示される", () => {
    ...
    cy.contains("閲覧履歴").click({ force: true })
...
describe("閲覧履歴の作成", () => {
  ...
  it("ログイン状態で参考書詳細ページにアクセスすると、参考書が閲覧履歴一覧に表示される", () => {
    ...
    cy.contains("閲覧履歴作成用参考書1").click({ force: true })
    ...
    cy.get("[data-cy=header-user-menu-list]").contains("閲覧履歴").click({ force: true })
  ...
  it("ログイン状態でレビュー詳細ページにアクセスすると、レビューが閲覧履歴一覧に表示される", () => {
    ...
    cy.contains("閲覧履歴作成用レビュー1").click({ force: true })
  ...
  it("ログイン状態で質問詳細ページにアクセスすると、質問が閲覧履歴一覧に表示される", () => {
    ...
    cy.contains("閲覧履歴作成用質問1").click({ force: true })
  ...
  it("ログイン状態で返信詳細ページにアクセスすると、返信が閲覧履歴一覧に表示される", () => {
    ...
    cy.get("[data-cy=each-question-replies]").first().find("textarea").should("have.value", "閲覧履歴作成用返信1").click({ force: true })
  ...
  it("ログイン状態で科目別質問詳細ページにアクセスすると、科目別質問が閲覧履歴一覧に表示される", () => {
    ...
    cy.contains("閲覧履歴作成用科目別質問1").click({ force: true })
  ...
  it("ログイン状態で科目別返信詳細ページにアクセスすると、科目別返信が閲覧履歴一覧に表示される", () => {
    ...
    cy.get("[data-cy=each-subject-question-subject-question-replies]").first().find("textarea").should("have.value","閲覧履歴作成用科目別返信1").click({ force: true })
  ...
  it("ログイン状態でアンケート詳細ページにアクセスすると、アンケートが閲覧履歴一覧に表示される", () => {
    ...
    cy.contains("閲覧履歴作成用アンケート1").click({ force: true })
...
describe("閲覧履歴の削除", () => {
  ...
  it("参考書の閲覧履歴が10件存在する状態で参考書詳細ページにアクセスすると、一番古い閲覧履歴が削除され、参考書の新しい閲覧履歴が作成される", () => {
    ...
    cy.contains("閲覧履歴作成用参考書2").click({ force: true })
  ...
  it("レビューの閲覧履歴が10件存在する状態でレビュー詳細ページにアクセスすると、一番古い閲覧履歴が削除され、レビューの新しい閲覧履歴が作成される", () => {
    ...
    cy.contains("閲覧履歴作成用レビュー2").click({ force: true })
  ...
  it("質問の閲覧履歴が10件存在する状態で質問詳細ページにアクセスすると、一番古い閲覧履歴が削除され、質問の新しい閲覧履歴が作成される", () => {
    ...
    cy.contains("閲覧履歴作成用質問2").click({ force: true })
  ...
  it("返信の閲覧履歴が10件存在する状態で返信詳細ページにアクセスすると、一番古い閲覧履歴が削除され、返信の新しい閲覧履歴が作成される", () => {
    ...
    cy.get("[data-cy=each-question-replies]").eq(1).find("textarea").should("have.value", "閲覧履歴作成用返信2").click({ force: true })
  ...
  it("科目別質問の閲覧履歴が10件存在する状態で科目別質問詳細ページにアクセスすると、一番古い閲覧履歴が削除され、科目別質問の新しい閲覧履歴が作成される", () => {
    ...
    cy.contains("閲覧履歴作成用科目別質問2").click({ force: true })
  ...
  it("科目別返信の閲覧履歴が10件存在する状態で科目別返信詳細ページにアクセスすると、一番古い閲覧履歴が削除され、科目別返信の新しい閲覧履歴が作成される", () => {
    ...
    cy.get("[data-cy=each-subject-question-subject-question-replies]").eq(1).find("textarea").should("have.value","閲覧履歴作成用科目別返信2").click({ force: true })
  ...
  it("アンケートの閲覧履歴が10件存在する状態でアンケート詳細ページにアクセスすると、一番古い閲覧履歴が削除され、アンケートの新しい閲覧履歴が作成される", () => {
    ...
    cy.contains("閲覧履歴作成用アンケート2").click({ force: true })
