<template>
  <div>
    <v-row mb-5 v-for="(subjectQuestionReply, index) in subjectQuestionReplies" :key="'subjectQuestionReply_' + index" data-cy="each-subject-question-subject-question-replies">
      <v-col>
