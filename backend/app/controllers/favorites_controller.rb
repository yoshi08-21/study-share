class FavoritesController < ApplicationController
  ...
  def index
    ...
    favorite_books_with_images = attach_image_to_favorite_books(favorite_books)
    ...
    favorite_questions_with_images = attach_image_to_favorite_questions(favorite_questions)
    ...
    favorite_subject_questions_with_images = attach_image_to_favorite_subject_questions(favorite_subject_questions)
  ...
  def attach_image_to_favorite_books(favorite_books)
    favorite_books_with_images = favorite_books.map do |favorite_book|
      ...
      favorite_books_with_images
    end


    def attach_image_to_favorite_questions(favorite_questions)
      favorite_questions_with_images = favorite_questions.map do |question|
      ...
      favorite_questions_with_images
    end

    def attach_image_to_favorite_subject_questions(favorite_subject_questions)
      favorite_subject_questions_with_images = favorite_subject_questions.map do |question|
        question_data = question.as_json
      ...
      favorite_subject_questions_with_images
    end
