class FavoritesController < ApplicationController
  ...
  def index
    ...
    favorite_replies = current_user.fav_replies.with_attached_image.includes(user: { image_attachment: :blob }).select("replies.*, (SELECT COUNT(*) FROM favorite_replies WHERE favorite_replies.reply_id = replies.id) AS favorite_replies_count")
